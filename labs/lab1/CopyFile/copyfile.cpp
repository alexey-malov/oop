...
int main(int argc, char * argv[])
{
	...
	// Этот цикл закончится как при окончании входного файла так и при возникновении ошибки чтения.
	// Дополните код так, чтобы в случае ошибки чтения, сообщить об этом пользователю
