...
Формат ввода: на вход первой сторокой поступает команда компрессии или декомпрессии(pack/unpack), второй сторокой вводятся данные в 16-ричной системе счисления.
```sh
pack
AAAABBCC
```
