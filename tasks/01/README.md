...
- [Лабораторная работа №1. Работа с внешними файлами, использование массивов и операций манипулирования битами.](#лабораторная-работа-1-работа-с-внешними-файлами-использование-массивов-и-операций-манипулирования-битами)
  - [Обязательные задания](#обязательные-задания)
    - [Задание  1](#задание-1)
      ...
      - [Вариант №3 – findtext – 50 баллов](#-3--findtext--50--namefindtext)
      - [Вариант №4 – replace – 80 баллов](#-4--replace--80-)
      - [Вариант №5 – join – 50 баллов](#-5--join--50-namejoin)
    ...
    - [Задание 2](#задание-2)
      ...
      - [Вариант №6 – radix – 100 баллов](#вариант-6–-radix–-100баллов)
    - [Задание 3](#задание-3)
...
#### Вариант №3 – findtext – 50 баллов [](#){name=findtext}
...
#### [Вариант №5 – join – 50 баллов](#){name=join}
