...
Входной лабиринт (без отрисованного пути) строится из 3 символов: 'A' - начало лабиринта, 'B' - конец лабиринта,
'#' - стена лабиринта.

В случае некорректных входных данных (например, встретился неизвестный символ):
...
Выходной лабиринт (с отрисованным путем) строится из 4 символов: 'A' - начало лабиринта, 'B' - конец лабиринта,
'#' - стена лабиринта, '.' - Путь от 'A' до 'B'.
