...
Символ 'O' (английская заглавня буква) обозначает точки, начиная с которых должна выполняться заливка контуров.
...
- **Ввод через командную строку:** Программа принимает 2 аргумента в качестве параметров командной строки,
  первый - название входного файла, второй - название выходного файла
- **Ввод через stdin:** Если программа запускается без параметров, она должна построчно принимать изображение
  из стандартного потока. Концом ввода изображения служит симовол - 'e' (английская строчная буква),
  введенная на последней строке
...
**При вводе через stdin** программа должна вывести результат своей работы в стандартный выходной поток.
