...
- Попытка переключить передачу при выключенном двигателе: "Engine is off: cannot set gear"
...
- Попытка установить скорость при выключенном двигателе: "Engine is off: cannot set speed"
- Попытка увеличить скорость на нейтральной (0) передаче: "Cannot accelerate on neutral"
- Попытка установить скорость, выходящую за допустимый диапазон для текущей передачи: "Speed is out of gear range"
