  ...
  - [Дополнительные задания](#дополнительные-задания)
    - [Задание 2 – Калькулятор – 300 баллов ](#задание-2--калькулятор--300-баллов-)
      ...
      - [Примеры работы программы](#примеры-работы-программы)
        ...
        - [Пример 6: Переполнение при вычислении значения функции](#пример-6-переполнение-при-вычислении-значения-функции)
      - [Бонус в 200 баллов за оптимизацию вычислений функций](#бонус-в-200-баллов-за-оптимизацию-вычислений-функций)
      - [Бонус в 100 баллов за возможность вычисления очень больших последовательностей функций](#бонус-в-100-баллов-за-возможность-вычисления-очень-больших-последовательностей-функций)
  - [Ссылки](#ссылки)
...
- При запуске без параметров командной строки программа считывает команды из `stdin` и выводит результаты в `stdout`.
  Работа программы завершается при обнаружении конца файла.
  
- При запуске из командной строки с параметром  `-h` программа выводит справку.

Каждая строка из `stdin` содержит одну из следующих команд:
...
- `printfns`
  ...
  **<идентификатор>:<значение>**
  ...
  выведено **nan**. Если ни одной функции не было объявлено к моменту выполнения команды `printfns`, в `stdout`
...
- Если название команды было введено неверно (неизвестная команда): "Invalid command"
...
- Если при вычислении функции произошло переполнение: “Calculation overflow”
- Если присваемое значение превышает максимальное (для типа double): “Assignment overflow”
...
##### Пример 6: Переполнение при вычислении значения функции
