# Лабораторная работа №7. Обобщенное программирование, шаблоны <a name="lw"></a>

- [Лабораторная работа №7. Обобщенное программирование, шаблоны](#lw)
     - [Обязательные задания](#обязательные-задания)
         - [Задание 1](#1)
              - [Вариант 1. 10 баллов – Sort2](#1-1)
              - [Вариант 2. 20 баллов - FindMax](#1-2)
              - [Вариант 3. 30 баллов - FindMaxEx](#1-3)
              - [Вариант 4. 20 баллов. - ArraySum](#1-4)
         - [Задание 2](#2)
              - [Вариант 1 – 150 баллов - CMyArray](#2-1)
                 - [Бонус в 20 баллов](#2-1-b-1)
              - [Вариант 2 – 80 баллов - CMyStack](#2-2)
              - [Вариант 3 – 150 баллов - CMyList](#2-3)
     - [Дополнительные задания](#дополнительные-задания)
          - [Задание 3](#3)
               - [Вариант 1. 100 баллов - People](#3-1)
               - [Вариант 2. 120 баллов - Vehicle](#3-2)
...
#### Вариант 1. 10 баллов – Sort2 <a name="1-1"></a>
...
#### Вариант 2. 20 баллов - FindMax <a name="1-2"></a>
...
### Вариант 3. 30 баллов - FindMaxEx <a name="1-3"></a>
...
#### Вариант 4. 20 баллов. - ArraySum <a name="1-4"></a>
...
#### Вариант 1 – 150 баллов - CMyArray <a name="2-1"></a>
...
<span style="color:gray">**Бонус в 20 баллов**</span> <a name="2-1-b-1"></a>
...
#### Вариант 2 – 80 баллов - CMyStack <a name="2-2"></a>
...
#### Вариант 3 – 150 баллов - CMyList <a name="2-3"></a>
...
### Задание 3 <a name="3"></a>
#### Вариант 1. 100 баллов - People <a name="3-1"></a>
...
#### Вариант 2. 120 баллов - Vehicle <a name="3-2"></a>
...
![vehicle-hierarcy-updated](images/vehicle-hierarcy-updated.png)

Фактически во время компиляции на этапе инстанциирования шаблонов компилятором будет построена следующая иерархия (произойдет «расщепление» базового шаблонного класса `IVehicle`):
...
На этапе инстанциирования шаблонов из нее будет построена следующая:
...
*	Конкретные классы сущностей предметной области
     *	`CTaxi` – реализует методы интерфеса `ITaxi` (в нашем случае таких методов нет), наследуется от шаблона `CCarImpl`
