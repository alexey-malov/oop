...
Реализовать и протестировать класс `CMyString`, моделирующий строку произвольной длины. На основе этого класса разработайте программу, которая должна cчитывать из стандартного потока команду и выводить результат ее выполнения. Примеры приведены в таблице.
    ...
    <tbody>
        <tr>
            ...
            <th>Присваивание CMyString (присваивание других типов, принимаемые конструктором класса будут реализованы автоматически)
                ...
                <br>s = s;</th>
            <th>
                <br>1.= "was"ms "became"ms
                <br>2.= "was"ms "became"s
                <br>3.= "was"ms "became"</th>
            <th>
                <br>1."became"ms
                <br>2."became"ms
                <br>3."became"ms</th>
        ...
        <tr>
            ...
            <th>
                <br>1.+ "Hello"ms " world"ms
                <br>2.+ "Hello"s " world"ms
                <br>3.+ "Hello" " world"ms</th>
                <th>
                <br>1."Hello world"ms
                <br>2."Hello world"ms
                <br>3."Hello world"ms</th>
        ...
        <tr>
            ...
            <th>
                <br>1.== "Hello"ms "Hello"ms
                <br>2.== "world"ms " world"ms
                <th>
                <br>1.TRUE
                <br>2.FALSE
        </tr>
        ...
        <tr>
            ...
            <th>
                <br>1.< "apple"ms "banana"ms
                <br>2.< "hello"ms "hello"ms</th>
            <th>
                <br>1.TRUE
                <br>2.FALSE</th>
        </tr>
        ...
        <tr>
            ...
            <th>
                <br>1.[0] "Hello world"ms
                <br>2.[6] "Hello world"ms m
                <br>3.[30] "Hello world"ms
                <br>4.[30] "Hello world"ms m</th>
            <th>
                <br>1.'H'
                <br>2."Hello morld"ms
                <br>3.ERROR
...
<br>Также нужно реализовать обработку вызова функции SubString. В формате:

Вход:
```sh
SubString <строка MyString> <начало> <длина>
```
