...
Выводите числа по неубыванию, округляйте их до сотых. В случае совпадения корней, выводите оба.
...
<table>
    ...
    <tr>
        <td>Нулевой коэффицент при х^4</td>
        <td>Invalid argument</td>
    </tr>
    <tr>
        <td>Отсутствие действительных корней для данного уравнения</td>
        <td>Domain error</td>
    </tr>
    <tr>
        <td>Некорректный формат ввода</td>
