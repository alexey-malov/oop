...
Напишите программу, реализующую класс `CStringStack`. Программа работает с одним стеком строк и поддерживает следующие команды:
...
<table>
    ...
    <tr>
        <td>Добавляет строку в стек</td>
        <td>push <строка></td>
        <td>ничего не выводит</td>
    </tr>
    <tr>
        <td>Удаляет и возвращает верхний элемент стека</td>
        <td>pop</td>
        <td><крайний элемент></td>
    </tr>
    <tr>
        <td>Удаляет все элементы из стека</td>
        <td>clear</td>
        <td>ничего не выводит</td>
    </tr>
    <tr>
        <td>Выводит количество элементов в стеке</td>
        <td>size</td>
        <td><число></td>
    </tr>
    <tr>
        <td>Проверяет стек на пустоту. Выводит TRUE, если пуст, иначе FALSE.</td>
        <td>empty</td>
        <td>TRUE или FALSE</td>
    </tr>
    <tr>
        <td>Выводит все элементы стека через пробел. Если стек пустой, ничего не выводит.</td>
        <td>print</td>
        <td><элементы стека>, где <элементы стека> ::= <крайний элемент> <остальные элементы> | <крайний элемент></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Попытка удаления элемента из пустого стека</td>
        <td>"Cannot pop from empty stack"</td>
    </tr>
    <tr>
