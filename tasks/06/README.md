...
Напишите программу, реализующую класс `CStudent`. Программа работает с одним студентом и поддерживает следующие команды:
<table>
    <tr>
        <th>Описание</th>
        <th>Формат ввода</th>
    ...
    <tr>
        <td>Создает студента. При создании мы переключаемся на работу с этим студентом. Если до этого работали с другим студентом, забываем его.</td>
        <td>create <имя> <фамилия> <отчество> <возраст> или create <имя> <фамилия> <возраст></td>
        <td>ничего не выводит</td>
    </tr>
    <tr>
        <td>Выводит имя студента</td>
        <td>name</td>
        <td><имя></td>
    </tr>
    <tr>
        <td>Выводит фамилию студента</td>
        <td>surname <позиция></td>
        <td><фамилия></td>
    </tr>
    <tr>
        <td>Выводит отчество студента</td>
        <td>patronymic</td>
        <td><отчество> или "Patronymic not set"</td>
    </tr>
    <tr>
        <td>Выводит возраст студента</td>
        <td>age</td>
        <td><возраст></td>
    </tr>
    <tr>
        <td>Переименовывает студента</td>
        <td>rename</td>
        <td>ничего не выводит</td>
    </tr>
    <tr>
        <td>Устанавливает возраст студента</td>
        <td>setAge</td>
        <td>ничего не выводит</td>
    </tr>
</table>

где `<фамилия> <отчество> <возраст>` - строки. `<возраст>` - целое число от 14 до 60.
...
<table>
    ...
    <tr>
        <td>Создание студента с некорректным ФИО</td>
        <td>Invalid argument</td>
    </tr>
    <tr>
        <td>Установка невалидного возраста или создания студента с таким возрастом</td>
        <td>"Out of range"</td>
    </tr>
    <tr>
        <td>Получение или изменение информации о студенте до его создания</td>
        <td>"Student not set"</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Установка возраста меньшего, чем существующий</td>
        <td>"Domain error"</td>
    </tr>
    <tr>
        <td>Нехватка памяти при создании студента или переименовании</td>
        <td>"Bad alloc"</td>
    </tr>
</table>
