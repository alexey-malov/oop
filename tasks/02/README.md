...
Программа должна записать в стандартный поток или файл результат замены всех шаблонных параметров на соответствующие значения согласно правилам подстановки.
...
Работа через stdin:
```
Сегодня на улице тепло, но иногда бывает и соленый ветер. Чудо день!
тепло := холодно
соленый := сладкий
день := ночь
```
...
Результат:
```
Сегодня на улице холодно, но иногда бывает и сладкий ветер. Чудо ночь!
```
