...
```txt
1.500 2.600 3.000 28.290 50.430
```

Объяснение: минимальный элемент - -4.1, максимальный - 3.0, их произведение - -12.3. Отрицательные элементы: -2.3, -4.1, умножаем на произведение (-12.3).
...
Объяснение: отрицательных элементов нет. 
...
Объяснение: в массиве есть буквы - выводим ошибку.
