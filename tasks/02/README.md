...
Список недопустимых слов задается в первой строке из стандартного потока ввода(слова разделены последовательностью из одного и более пробелов или табуляций).

Все последующие строки, вводимые из стандартного потока ввода, являются текстом, из которого нужно убрать недопустимые слова, после обработки нужно вывести результат в стандартный поток вывода.
