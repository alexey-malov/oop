...
```txt
0.714 1.071 1.428 2.000
```

Объяснение: каждый элемент был разделен на 28, так как максимальный элемент равен 56.
...
Объяснение: каждый элемент был разделен на 2, так как максимальный элемент равен 4.0.
...
Объяснение: каждый элемент был разделен на -0.5, так как максимальный элемент равен -1.0
