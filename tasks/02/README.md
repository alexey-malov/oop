...
1. Ввод параметров должен прерываться на пустой строке
...
- Если неверный формат пары параметр-значение или отсутствует значение после разделителя: "Invalid input"
