...
Объяснение: считываем 3.659512, как 3.66. Среднее арифмитическое - 2.22, прибавляем его к всем элементам.
...
```txt
14.000 26.000 -20.000 20.000
```

Объяснение: положительные числа - 4, 16, 10, их среднее арифмитическое - 10, прибавляем его к всем элементам.
...
```txt
-1.000 -703.000 -3.660 -11.000
```

Объяснение: все числа отрицательные, выводим их без изменений, в правильном форматировании.
...
Объяснение: "-" - символ, выписываем сообщение об ошибке, неправильно введено значение.
...
на минимальный элемент исходного массива.
