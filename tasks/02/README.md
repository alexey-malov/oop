...
Если входные данные некорректны (например, не указан протокол http/https), программа должна выводить в стандартный поток вывода «ERROR» и завершиться с кодом возврата 0. Это необходимо для корректного тестирования программы в системе Яндекс.Contest
...
Объяснение: в первой строке выписываем переданную URL-строку, во второй домен, в третьей подставляем порт по умолчания для http - 80.
...
Объяснение: в первой строке выписываем переданную URL-строку, во второй домен, в третьей подставляем, переданный порт, в четвертой отписываем документ.
...
Объяснение: передан неправильный протокол, выписываем "ERROR".
...
Объяснение: в первой строке выписываем переданную URL-строку, во второй домен, в третьей подстваляем порт по умолчания для http - 80, в четвертой отписываем документ.
