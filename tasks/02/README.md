    ...
    - [Задание 6](#задание-6)
      - [Вариант №1 – Expand Template – 100 баллов ](#вариант-1--expand-template--100-баллов-)
        ...
        - [Примеры входных и выходных данных](#примеры-входных-и-выходных-данных-8)
          ...
          - [Пример 5: Неуникальынй ключ](#пример-5-неуникальынй-ключ)
...
Объяснение: в указанных шаблонных параметрах после разделителя `:=` ничего не следует,
