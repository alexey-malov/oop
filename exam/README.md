...
- [Средства языка C++ для работы с динамической памятью](#средства-языка-c-для-работы-с-динамической-памятью)
- [Адресная арифметика](#адресная-арифметика)
- [Проблемы ручного управления памятью и их решение](#проблемы-ручного-управления-памятью-и-их-решение)
...
## Средства языка C++ для работы с динамической памятью

## Адресная арифметика

## Проблемы ручного управления памятью и их решение
...
3.  Когда нужно создавать пользовательские конструктор/деструктор/операции присваивания?
4.  Запрещение копирования, присваивания, перемещения объектов
